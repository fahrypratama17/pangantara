  ...
  return (
    <TabsPrimitive.Trigger
      ...
      className={cn(
        ...
        "group-data-[variant=line]/tabs-list:bg-orange-600 group-data-[variant=line]/tabs-list:data-active:bg-orange-600 dark:group-data-[variant=line]/tabs-list:data-active:border-transparent dark:group-data-[variant=line]/tabs-list:data-active:bg-orange-600",
        "data-active:text-foreground dark:data-active:border-input dark:data-active:bg-input/30 dark:data-active:text-foreground data-active:bg-orange-600",
