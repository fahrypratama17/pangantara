        ...
        <Field className="mx-auto mb-6 w-[80%]">
          <div className="space-y-2">
            <div className="relative">
              <Input className="px-10" placeholder="Masukkan Nama Dapur" />
              <Package
            ...
            <div className="relative">
              <Input className="px-10" placeholder="Masukkan Alamat" />
              <MapPin
                className="absolute top-3 left-3"
                width={20}
                height={20}
          ...
          <div className="flex items-center justify-end gap-2">
            ...
            <Link href="/register/password" className="rounded-full border p-2">
              <ArrowRight width={20} height={20} />
            </Link>
          </div>
        </Field>
        <div className="mx-auto w-[80%] space-y-4">
          <p className="text-center">Atau daftar dengan</p>
